...
$latestBlog = [
	[
		...
		"intro" => "On your JavasScript journey, you’ve come across Primitive Data Types and Reference Data Types. You probably learned that the main difference between...",
		"read-time" => 5,
		"demo" => false,
		"front-page" => true,
	],
	...
	[
		...
		"intro" => "A Scalable Vector Graphic, or SVG for short, is an image defined by geometric shapes (numbers) as opposed to bitmap images. Unlike JPG and PNG...",
		"read-time" => 4,
		"demo" => false,
		"front-page" => false,
	],
