 <section class="signup-cs case-study">
		<section class="container">
			<div class="cs-heading">
				...
				<p class="body-copy">This week on my journey to learn Javascript, I encountered functions and event handlers. To improve my knowledge and as a challenge to myself, I wanted to build my own sign up page and try and mimic the ones you see everyday in the wild.</p>
			</div>
