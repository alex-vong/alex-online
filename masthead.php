<inner-column>
	<div class="blur"></div>
	<masthead id='desktop-masthead'>
		<a href="?page=home" class="logo">
			<h2 class="intro-voice desktop">Alex Vong</h2>
		</a>
		...
		<nav class="nav-bar nav-bar-desktop">
			...
			if ($page == "home") { ?>
				<div class="nav-links">
					<a href="#home" class="home quiet-voice <?php if ($page == "home") {
																echo "active";
															} ?>">Home</span></a>
			...
			if ($page && $page != "home") { ?>
				<div class="nav-links">
					...
					<a href="?page=projects" class="projects quiet-voice <?php if ($page == "projects") {
																				echo "active";
																			} ?>"><span>Projects</span></a>
					<a href="?page=writing" class="writing quiet-voice <?php if ($page == "writing") {
																			echo "active";
																		} ?>"><span>Writing</span></a>
				</div>
			<?php }
	...
	<masthead id="mobile-masthead">
		...
		if ($page != 'todo-app-cs' && $page != 'weather-app-cs' && $page != 'signup-cs' && $page != 'style-guide') { ?>
			...
			<nav class="nav-bar nav-bar-mobile">
				<?php
				if ($page == "home") { ?>
					<a href="#home" class=" home-mobile body-copy <?php if ($page == "home") {
																		echo "active";
																	} ?>">
				...
				if ($page == "about" || $page == "projects" || $page == "writing") { ?>
					...
					<a href="?page=home" class="home body-copy <?php if ($page == "home") {
																	echo "active";
																} ?>">
						<span class="<?php if ($page == "home") {
											echo "active";
					...
					<a href="?page=about" class="about body-copy <?php if ($page == "about") {
																		echo "active";
																	} ?>">
						<i class="fa-regular fa-address-card"></i>
					</a>
					<a href="?page=projects" class="projects body-copy <?php if ($page == "projects") {
																			echo "active";
																		} ?>">
						<i class="fa-regular fa-folder"></i>
					</a>

					<a href="?page=writing" class="writing body-copy <?php if ($page == "writing") {
																			echo "active";
																		} ?>">
						<i class="fa-regular fa-pen-to-square"></i>
